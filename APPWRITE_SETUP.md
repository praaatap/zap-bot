...
2. Edit `.env.local` and fill in the Appwrite credentials:
   ...
   APPWRITE_STORAGE_BUCKET_ID=recordings
   OBJECT_STORAGE_PROVIDER=appwrite
   ```
...
- Create the storage bucket `recordings` (or `APPWRITE_STORAGE_BUCKET_ID`) for meeting media
